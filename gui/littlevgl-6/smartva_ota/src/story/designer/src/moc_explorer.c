	...
	switch(type) {
		case RAT_MEDIA_TYPE_PIC:
			if (explorer_src[EXPLORER_IMAGE_PICTURE] == NULL) {
				explorer_src[EXPLORER_IMAGE_PICTURE] = parse_image_from_file(EXPLORER_IMAGE_PICTURE_PATH);
			}
		...
		case RAT_MEDIA_TYPE_AUDIO:
			if (explorer_src[EXPLORER_IMAGE_AUDIO] == NULL) {
				explorer_src[EXPLORER_IMAGE_AUDIO] = parse_image_from_file(EXPLORER_IMAGE_AUDIO_PATH);
			}
		...
		case RAT_MEDIA_TYPE_VIDEO:
			if (explorer_src[EXPLORER_IMAGE_VIDEO] == NULL) {
				explorer_src[EXPLORER_IMAGE_VIDEO] = parse_image_from_file(EXPLORER_IMAGE_VIDEO_PATH);
			}
		...
		case RAT_MEDIA_TYPE_FIRMWARE:
			if (explorer_src[EXPLORER_IMAGE_FIRMWARE] == NULL) {
				explorer_src[EXPLORER_IMAGE_FIRMWARE] = parse_image_from_file(EXPLORER_IMAGE_FIRMWARE_PATH);
			}
		...
		case RAT_MEDIA_TYPE_EBOOK:
			if (explorer_src[EXPLORER_IMAGE_TEXT] == NULL) {
				explorer_src[EXPLORER_IMAGE_TEXT] = parse_image_from_file(EXPLORER_IMAGE_TEXT_PATH);
			}
		...
		case RAT_MEDIA_TYPE_UNKNOWN:
			if (explorer_src[EXPLORER_IMAGE_UNKOWN] == NULL) {
				explorer_src[EXPLORER_IMAGE_UNKOWN] = parse_image_from_file(EXPLORER_IMAGE_UNKOWN_PATH);
			}
		...
		case RAT_MEDIA_TYPE_FOLDER:
			...
			if (explorer_src[EXPLORER_IMAGE_FOLDER] == NULL) {
				explorer_src[EXPLORER_IMAGE_FOLDER] = parse_image_from_file(EXPLORER_IMAGE_FOLDER_PATH);
			}
			...
			if (explorer_src[EXPLORER_IMAGE_MORE] == NULL) {
				explorer_src[EXPLORER_IMAGE_MORE] = parse_image_from_file(EXPLORER_IMAGE_MORE_PATH);
			}
	...
	switch(type) {
		case RAT_MEDIA_TYPE_SD_DEVICE:
			if (explorer_src[EXPLORER_IMAGE_SD] == NULL) {
				explorer_src[EXPLORER_IMAGE_SD] = parse_image_from_file(EXPLORER_IMAGE_SD_PATH);
			}
		...
		case RAT_MEDIA_TYPE_USB_DEVICE:
			if (explorer_src[EXPLORER_IMAGE_USB] == NULL) {
				explorer_src[EXPLORER_IMAGE_USB] = parse_image_from_file(EXPLORER_IMAGE_USB_PATH);
			}
...
static void Explorer_DiskHotPlugCallBack(DiskInfo_t *DiskInfo) {
	...
	if (DiskInfo->operate == MEDIUM_PLUGIN || DiskInfo->operate == MEDIUM_STATIC_PLUGIN) {
...
//	rat_media_type_t Type = RAT_MEDIA_TYPE_EBOOK;
	...
	if (Type == RAT_MEDIA_TYPE_ALL) {
		...
		backImageBuff = (void *)parse_image_from_file(LV_IMAGE_PATH"explorer_return.png");
