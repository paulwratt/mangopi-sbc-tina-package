...
void calendar_auto_ui_create(calendar_ui_t *ui)
{
	...
	style3_calendar_1.text.font = &microsoft_yahei_en_cn_24_4;
	...
	static lv_calendar_date_t calendar_1_today_date;
	...
	static lv_calendar_date_t calendar_1_show_date;
	...
	lv_obj_set_size(ui->label_1, 219, 19);
	...
	lv_obj_set_size(ui->label_2, 118, 32);
	...
	lv_obj_set_size(ui->label_3, 14, 32);
	...
	lv_obj_set_size(ui->label_4, 72, 32);
	...
	image_2_calendar_set_png = (void *)parse_image_from_file(LV_IMAGE_PATH"calendar_set.png");
