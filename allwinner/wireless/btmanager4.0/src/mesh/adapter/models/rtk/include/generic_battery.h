...
/**
 * @defgroup GENERIC_BATTERY_OPCODE generic battery opcode
 * @brief
 * @{
 */
...
#define RTK_MESH_MODEL_GENERIC_BATTERY_SERVER               0x100C
#define RTK_MESH_MODEL_GENERIC_BATTERY_CLIENT               0x100D
/**
 * @}
 */

/**
 * @defgroup GENERIC_BATTERY_MSG generic battery msg
 * @brief Message types used by generic battery models
 * @{
 */
...
/** @defgroup GENERIC_BATTERY_SERVER_DATA generic battery server data
...
/** @defgroup GENERIC_BATTERY_CLIENT_DATA generic battery client data
* @brief Data types and structure used by data process callback
* @{
*/
...
/** @defgroup GENERIC_BATTERY_SERVER_API   generic battery server api
...
/** @defgroup GENERIC_BATTERY_CLIENT_API   generic battery client api
  * @brief Functions declaration
  * @{
  */
