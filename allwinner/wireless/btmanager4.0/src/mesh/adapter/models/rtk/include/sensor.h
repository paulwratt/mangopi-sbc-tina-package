...
/** @defgroup SENSOR_OPCODE sensor opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_SENSOR_SERVER                          0x1100
#define RTK_MESH_MODEL_SENSOR_SETUP_SERVER                    0x1101
#define RTK_MESH_MODEL_SENSOR_CLIENT                          0x1102
/** @} */

/** @defgroup SENSOR_DB sensor database
  * @brief Database used by sensors
  * @{
  */
...
/** @defgroup SENSOR_MSG sensor msg
  * @brief Message types used by sensor models
  * @{
  */
typedef struct
{
...
/** @defgroup SENSOR_SERVER_DATA sensor server data
...
/** @defgroup SENSOR_CLIENT_DATA sensor client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup SENSOR_SERVER_API   sensor server api
 ...
 */
uint8_t sensor_tolerance_to_percentage(uint16_t tolerace);
...
mesh_msg_send_cause_t sensor_descriptor_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                            uint8_t app_key_index, uint16_t property_id);
...
mesh_msg_send_cause_t sensor_cadence_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                         uint8_t app_key_index, uint16_t property_id, const sensor_cadence_t *cadence, bool ack);
...
mesh_msg_send_cause_t sensor_setting_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                         uint8_t app_key_index, uint16_t property_id, uint16_t setting_property_id);
...
mesh_msg_send_cause_t sensor_column_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                        uint8_t app_key_index, uint16_t property_id, uint8_t raw_value_x_len, const void *raw_value_x);
...
mesh_msg_send_cause_t sensor_series_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                        uint8_t app_key_index, uint16_t property_id, uint8_t raw_value_x_len, const void *raw_value_x1,
                                        const void *raw_value_x2);
