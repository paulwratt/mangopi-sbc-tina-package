...
/** @defgroup Mesh_Common_Exported_Types Mesh Common Exported Types
  * @brief
  * @{
  */
...
/** @defgroup Mesh_Common_Exported_Functions Mesh Common Exported Functions
  * @brief
  * @{
  */
