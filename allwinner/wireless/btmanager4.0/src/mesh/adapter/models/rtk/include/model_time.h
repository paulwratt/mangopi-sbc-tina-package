...
/** @defgroup TIME_OPCODE time opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_TIME_SERVER                          0x1200
#define RTK_MESH_MODEL_TIME_SETUP_SERVER                    0x1201
#define RTK_MESH_MODEL_TIME_CLIENT                          0x1202
/** @} */

/** @defgroup TIME_MSG time msg
  * @brief Message types used by time models
  * @{
  */
...
/** @defgroup TIME_SERVER_DATA time server data
...
/** @defgroup TIEM_CLIENT_DATA time client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
typedef tai_time_t       time_client_status_t;
...
/** @defgroup TIME_SERVER_API   time server api
...
mesh_msg_send_cause_t time_status(mesh_model_info_p pmodel_info, uint16_t dst,
                                  uint8_t app_key_index, tai_time_t time_info);
mesh_msg_send_cause_t time_zone_status(mesh_model_info_p pmodel_info, uint16_t dst,
                                       uint8_t app_key_index, time_zone_t time_zone);
mesh_msg_send_cause_t tai_utc_delta_status(mesh_model_info_p pmodel_info, uint16_t dst,
                                           uint8_t app_key_index, tai_utc_delta_t tai_utc_delta);
/** @} */

/** @defgroup TIME_CLIENT_API   time client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t time_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                               uint8_t app_key_index, tai_time_t time);
...
mesh_msg_send_cause_t time_set_zone(const mesh_model_info_p pmodel_info, uint16_t dst,
                                    uint8_t app_key_index, uint8_t time_zone_offset_new,
...
mesh_msg_send_cause_t time_set_tai_utc_delta(const mesh_model_info_p pmodel_info,
                                             uint16_t dst,
                                             uint8_t app_key_index, uint16_t tai_utc_delta_new,
...
mesh_msg_send_cause_t time_set_role(const mesh_model_info_p pmodel_info, uint16_t dst,
                                    uint8_t app_key_index, time_role_t role);
