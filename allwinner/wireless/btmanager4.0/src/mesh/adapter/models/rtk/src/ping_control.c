...
mesh_msg_send_cause_t ping(uint16_t dst, uint8_t ttl, uint8_t app_key_index,
...
mesh_msg_send_cause_t big_ping(uint16_t dst, uint8_t ttl, uint8_t app_key_index,
                               uint16_t pong_max_delay)
{
...
mesh_msg_send_cause_t pong(uint16_t dst, uint8_t ttl, uint8_t app_key_index, uint8_t hops_forward,
                           uint16_t pong_delay)
{
    pong_t msg;
    msg.init_ttl = ttl;
...
mesh_msg_send_cause_t big_pong(uint16_t dst, uint8_t ttl, uint8_t app_key_index,
