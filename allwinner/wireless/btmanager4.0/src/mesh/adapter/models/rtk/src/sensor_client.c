...
static mesh_msg_send_cause_t sensor_client_send(const mesh_model_info_p pmodel_info,
                                                uint16_t dst, uint8_t app_key_index, uint8_t *pmsg, uint16_t msg_len)
{
    mesh_msg_t mesh_msg;
    ...
    case MESH_MSG_SENSOR_CADENCE_STATUS:
        {
            ...
            if (NULL != pmodel_info->model_data_cb)
            {
                sensor_client_status_cadence_t status_data = {0, NULL};
    ...
    case MESH_MSG_SENSOR_SETTING_STATUS:
        {
            ...
            if (NULL != pmodel_info->model_data_cb)
            {
                sensor_client_status_setting_t status_data = {0, 0, NULL};
    ...
    case MESH_MSG_SENSOR_STATUS:
        {
            ...
            if (NULL != pmodel_info->model_data_cb)
            {
                sensor_client_status_t status_data = {0, NULL};
