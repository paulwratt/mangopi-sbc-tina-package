...
/** @defgroup LIGHT_CTL_OPCODE light ctl opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_LIGHT_CTL_SERVER                     0x1303
#define RTK_MESH_MODEL_LIGHT_CTL_SETUP_SERVER               0x1304
#define RTK_MESH_MODEL_LIGHT_CTL_CLIENT                     0x1305
#define RTK_MESH_MODEL_LIGHT_CTL_TEMPERATURE_SERVER         0x1306 //!< TEMPERATURE msg/state is duplicate with CTL SERVER
/** @} */

/** @defgroup LIGHT_CTL_MSG light ctl msg
  * @brief Message types used by light ctl models
  * @{
  */
...
/** @defgroup LIGHT_CTL_TRANSITION_TYPE light ctl transition type
  * @brief
  * @{
  */
...
/** @defgroup LIGHT_CTL_SERVER_DATA light ctl server data
...
/** @defgroup LIGHT_CTL_CLIENT_DATA light ctl client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup LIGHT_CTL_SERVER_API   light ctl server api
...
/** @defgroup LIGHT_CTL_CLIENT_API   light ctl client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t light_ctl_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                    uint8_t app_key_index, uint16_t lightness, uint16_t temperature, int16_t delta_uv, uint8_t tid,
...
mesh_msg_send_cause_t light_ctl_temperature_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                                uint8_t app_key_index, uint16_t temperature, int16_t delta_uv, uint8_t tid, bool optional,
...
mesh_msg_send_cause_t light_ctl_temperature_range_set(const mesh_model_info_p pmodel_info,
                                                      uint16_t dst,
                                                      uint8_t app_key_index, uint16_t range_min, uint16_t range_max, bool ack);
...
mesh_msg_send_cause_t light_ctl_default_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                            uint8_t app_key_index, uint16_t lightness, uint16_t temperature, int16_t delta_uv, bool ack);
/** @} */
