...
/** @addtogroup Proxy_Protocol Proxy Protocol
  * @brief Proxy Service
  * @{
  */

/** @defgroup Proxy_Protocol_Exported_Macros Proxy_Protocol Exported Macros
  * @brief
  * @{
  */
...
/** @defgroup Proxy_Protocol_Exported_Types Proxy Protocol Exported Types
...
typedef bool (*proxy_send_sar_pf)(uint8_t ctx_id, uint8_t *pvalue, uint16_t len);
...
/** @defgroup Proxy_Protocol_Exported_Functions Proxy_Protocol Exported Functions
  * @brief
  * @{
  */
