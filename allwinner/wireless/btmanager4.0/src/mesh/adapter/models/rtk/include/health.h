...
/** @defgroup HEALTH_FAULT health fault
  * @brief Fault code
  * @{
  */
...
/** @defgroup HEALTH_MSG health msg
  * @brief Message types used by health models
  * @{
  */
...
/**
 * @defgroup HEALTH_SERVER_TEST_CALLBACK health server test callback
 * @brief Test callback
 * @{
 */
...
/** @defgroup HEALTH_CLIENT_DATA health client data
...
mesh_msg_send_cause_t health_fault_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                       uint8_t app_key_index, uint16_t company_id);
...
mesh_msg_send_cause_t health_fault_test(const mesh_model_info_p pmodel_info, uint16_t dst,
                                        uint8_t app_key_index, uint8_t test_id,
...
mesh_msg_send_cause_t health_attn_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                      uint8_t app_key_index, uint8_t attn, bool ack);
/** @} */
