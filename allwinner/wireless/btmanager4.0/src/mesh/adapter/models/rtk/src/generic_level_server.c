    ...
    case MESH_MSG_GENERIC_LEVEL_SET_UNACK:
        {
            ...
            if (IS_GENERIC_TRANSITION_STEPS_VALID(trans_time.num_steps))
            {
                ...
                int16_t present_level = generic_level_process(pmodel_info, GENERIC_LEVEL_SERVER_SET, 0,
    ...
    case MESH_MSG_GENERIC_MOVE_SET_UNACK:
        {
            ...
            if (IS_GENERIC_TRANSITION_STEPS_VALID(trans_time.num_steps))
            {
                ...
                int16_t present_level = generic_level_process(pmodel_info, GENERIC_LEVEL_SERVER_SET_MOVE,
                                                              pmsg->delta_level,
