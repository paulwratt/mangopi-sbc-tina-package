...
/** setting */
#define MESH_ONE_SHOT_ADV                       0 //!< adv
...
#define MESH_DATA_UART_DEBUG                    0 //!< Data uart debug
...
#include "data_uart.h"
#else
#define data_uart_debug(fmt, ...) printf(fmt, ##__VA_ARGS__)
void data_uart_dump_act(uint8_t *pbuffer, uint32_t len);
#define data_uart_dump(pbuffer,len) data_uart_dump_act(pbuffer, len)
#endif
...
#define MESH_ADV_INTERVAL_MIN                   0xA0 /* 20ms */
#define MESH_ADV_INTERVAL_MAX                   0xA0 /* 20ms */

/** Scan interval and window (units of 625us, 160=100ms), Value range: 0x0004 - 0x4000 (2.5ms - 10240ms, 0.625ms/step) */
#define MESH_SCAN_INTERVAL                      0x20 /* 20ms */
#if MESH_MUTE_MODE
#define MESH_SCAN_WINDOW                        MESH_SCAN_INTERVAL
#else
#define MESH_SCAN_WINDOW                        0x1e /* 18.75ms */
#endif

/** Connection interval, slave latency, supervision timeout */
#define MESH_LINK_NUM                           1
#define MESH_CONN_INTERVAL_MIN                  0x0006  // 100 milliseconds
#define MESH_CONN_INTERVAL_MAX                  0x0C80  // 4 seconds
#define MESH_SLAVE_LATENCY                      0
#define MESH_TIMEOUT_MULTIPLIER                 1000
#define MESH_CONN_SCAN_TIMEOUT                  1000
...
#define MESH_FRIENDSHIP_RX_WINDOW               (3 * MESH_SCAN_INTERVAL * 625 / 1000) //!< ms, set according to scan interval
