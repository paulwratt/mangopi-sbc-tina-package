...
/** @defgroup SCENE_OPCODE scene opcode
  * @brief
  * @{
  */
...
#define MESH_MODEL_SCENE_SERVER                          0x1203
#define MESH_MODEL_SCENE_SETUP_SERVER                    0x1204
#define MESH_MODEL_SCENE_CLIENT                          0x1205
/** @} */

/** @defgroup SCENE_MSG scene msg
  * @brief Message types used by scene models
  * @{
  */
...
/** @defgroup SCENE_TRANSITION_TYPE scene transition type
  * @brief
  * @{
  */
...
/**
 * @defgroup SCENE_STORAGE_MEMORY scene storage memory
 * @brief Scene storage memory definition
 * @{
 */
...
/** @defgroup SCENE_SERVER_DATA scene server data
...
/** @defgroup SCENE_CLIENT_DATA scene client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup SCENE_SERVER_API   scene server api
...
/** @defgroup SCENE_CLIENT_API   scene client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t scene_store(const mesh_model_info_p pmodel_info, uint16_t dst,
                                  uint8_t app_key_index, uint16_t scene_number, bool ack);
...
mesh_msg_send_cause_t scene_recall(const mesh_model_info_p pmodel_info, uint16_t dst,
                                   uint8_t app_key_index, uint16_t scene_number, uint8_t tid, bool optional,
