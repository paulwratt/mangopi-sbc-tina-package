...
/** @defgroup GENERIC_DEFAULT_TRANSITION_TIME_OPCODE generic default transition time opcode
  * @brief
  * @{
  */
...
#define MESH_MODEL_GENERIC_DEFAULT_TRANSITION_TIME_SERVER   0x1004
#define MESH_MODEL_GENERIC_DEFAULT_TRANSITION_TIME_CLIENT   0x1005
/** @} */

/** @defgroup GENERIC_DEFAULT_TRANSITION_TIME_MSG generic default transition time msg
  * @brief Message types used by generic default transition time models
  * @{
  */
typedef struct
{
...
/** @defgroup GENERIC_DEFAULT_TRANSITION_TIME_SERVER_DATA generic default transition time server data
...
/** @defgroup GENERIC_DEFAULT_TRANSITION_TIME_CLIENT_DATA generic default transition time client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup GENERIC_DEFAULT_TRANSITION_TIME_SERVER_API   generic default transition time server api
