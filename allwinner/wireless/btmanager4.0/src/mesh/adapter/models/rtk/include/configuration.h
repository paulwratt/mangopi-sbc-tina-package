...
/** @defgroup Configuration_MSG  Configuration Msg
  * @brief Msg types used by Configuration models
  * @{
  */
...
typedef enum
{
    ...
    MESH_MSG_STAT_NOT_SUB_MODEL, // TODO: What is not a sub model?
    ...
    MESH_MSG_STAT_UNSPECIFIED_ERROR,
    MESH_MSG_STAT_INVALID_BINDING,
} _PACKED_ mesh_msg_stat_t;
...
/** @defgroup CONFIGURATION_SERVER_API   Configuration Server API
...
/** @defgroup CONFIGURATION_CLIENT_API   Configuration Client API
  * @brief Functions declaration
  * @{
  */
