...
/** @defgroup LIGHT_LIGHTNESS_OPCODE light lightness opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_LIGHT_LIGHTNESS_SERVER               0x1300
#define RTK_MESH_MODEL_LIGHT_LIGHTNESS_SETUP_SERVER         0x1301
#define RTK_MESH_MODEL_LIGHT_LIGHTNESS_CLIENT               0x1302
/** @} */

/** @defgroup LIGHT_LIGHTNESS_MSG light lightness msg
  * @brief Message types used by light lightness models
  * @{
  */
typedef struct
{
...
/** @defgroup LIGHT_LIGHTNESS_TRANSITION_TYPE light lightness transition type
  * @brief
  * @{
  */
...
/** @defgroup LIGHT_LIGHTNESS_SERVER_DATA light lightness server data
...
{
    uint16_t lightness;
} light_lightness_server_get_last_t;

typedef struct
{
    uint16_t lightness;
} light_lightness_server_get_default_t;
...
/** @defgroup LIGHT_LIGHTNESS_CLIENT_DATA light lightness client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup LIGHT_LIGHTNESS_SERVER_API   light lightness server api
...
/** @defgroup LIGHT_LIGHTNESS_CLIENT_API   light lightness client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t light_lightness_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                          uint8_t app_key_index, uint16_t lightness, uint8_t tid, bool optional,
...
mesh_msg_send_cause_t light_lightness_default_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                                  uint8_t app_key_index, uint16_t lightness, bool ack);
