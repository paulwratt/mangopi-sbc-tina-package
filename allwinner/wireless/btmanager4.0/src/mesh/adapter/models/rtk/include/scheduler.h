...
/** @defgroup SCHEDULER_OPCODE scheduler opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_SCHEDULER_SERVER                     0x1206
#define RTK_MESH_MODEL_SCHEDULER_SETUP_SERVER               0x1207
#define RTK_MESH_MODEL_SCHEDULER_CLIENT                     0x1208
/** @} */

/** @defgroup SCHEDULER_MSG scheduler msg
  * @brief Message types used by scheduler models
  * @{
  */
...
/** @defgroup SCHEDULER_SERVER_DATA scheduler server data
...
/** @defgroup SCHEDULER_CLIENT_DATA scheduler client data
  * @brief Data types and structure used by data process callback
  * @{
  */
#define SCHEDULER_CLIENT_STATUS                                0 //!< @ref scheduler_client_status_t
#define SCHEDULER_CLIENT_STATUS_ACTION                         1 //!< @ref scheduler_client_action_status_t
...
typedef scheduler_register_t scheduler_client_status_action_t;

/** @} */

/** @defgroup SCHEDULER_SERVER_API   scheduler server api
...
/** @defgroup SCHEDULER_CLIENT_API   scheduler client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t scheduler_action_get(const mesh_model_info_p pmodel_info, uint16_t dst,
                                           uint8_t app_key_index, uint8_t index);
