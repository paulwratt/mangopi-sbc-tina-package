...
} prov_start_output_oob_action_t;
...
typedef void (*prov_cb_pf)(prov_cb_type_t cb_type, prov_cb_data_t cb_data);
...
bool prov_data_crypto(uint8_t data[38], bool encrypt_decrypt);
void prov_handle_disconnect(void);
void prov_handle_timeout(void);
void prov_disconnect(pb_adv_link_close_reason_t reason);
///@endcond
