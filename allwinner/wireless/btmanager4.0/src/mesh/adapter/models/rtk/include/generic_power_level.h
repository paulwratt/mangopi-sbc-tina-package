...
/** @defgroup GENERIC_POWER_LEVEL_OPCODE generic power level opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_GENERIC_POWER_LEVEL_SERVER           0x1009
#define RTK_MESH_MODEL_GENERIC_POWER_LEVEL_SETUP_SERVER     0x100A
#define RTK_MESH_MODEL_GENERIC_POWER_LEVEL_CLIENT           0x100B
/** @} */

/** @defgroup GENERIC_POWER_LEVEL_MSG generic power level msg
  * @brief Message types used by generic power level models
  * @{
  */
typedef struct
{
...
/** @defgroup GENERIC_POWER_LEVEL_TRANSITION_TYPE generic power level transition type
  * @brief
  * @{
  */
...
/** @defgroup GENERIC_POWER_LEVEL_SERVER_DATA generic power level server data
...
/** @defgroup GENERIC_POWER_LEVEL_CLIENT_DATA generic power level client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup GENERIC_POWER_LEVEL_SERVER_API   generic power level server api
...
mesh_msg_send_cause_t generic_power_range_stat(mesh_model_info_p pmodel_info, uint16_t dst,
                                               uint8_t app_key_index, generic_stat_t stat,
                                               uint16_t range_min, uint16_t range_max);
/** @} */

/** @defgroup GENERIC_POWER_LEVEL_CLIENT_API   generic power level client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t generic_power_default_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                                uint8_t app_key_index, uint16_t power, bool ack);
 ...
 * @param[in] range_min: power level maximum value
 * @param[in] ack: acknowledge flag
 * @return send status
 */
