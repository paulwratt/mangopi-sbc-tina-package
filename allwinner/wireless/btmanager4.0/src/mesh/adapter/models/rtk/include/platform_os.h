...
/** @addtogroup Mesh_Platform_OS Mesh Platform OS
  * @brief OS related
  * @{
  */

/** @defgroup Mesh_Platform_OS_Exported_Functions Mesh Platform OS Exported Functions
  * @brief
  * @{
  */
...
#define plt_timer_is_active(timer)                                  false //xTimerIsTimerActive(timer)
