...
/** @defgroup LIGHT_HSL_OPCODE light hsl opcode
  * @brief
  * @{
  */
...
#define RTK_MESH_MODEL_LIGHT_HSL_SERVER                     0x1307
#define RTK_MESH_MODEL_LIGHT_HSL_SETUP_SERVER               0x1308
#define RTK_MESH_MODEL_LIGHT_HSL_CLIENT                     0x1309
#define RTK_MESH_MODEL_LIGHT_HSL_HUE_SERVER                 0x130A
#define RTK_MESH_MODEL_LIGHT_HSL_SATURATION_SERVER          0x130B
/** @} */

/** @defgroup LIGHT_HSL_MSG light hsl msg
  * @brief Message types used by light hsl models
  * @{
  */
...
/** @defgroup LIGHT_HSL_TRANSITION_TYPE light hsl transition type
  * @brief
  * @{
  */
...
/** @defgroup LIGHT_HSL_SERVER_DATA light hsl server data
...
/** @defgroup LIGHT_HSL_CLIENT_DATA light hsl client data
  * @brief Data types and structure used by data process callback
  * @{
  */
...
/** @defgroup LIGHT_HSL_SERVER_API   light hsl server api
...
/** @defgroup LIGHT_HSL_CLIENT_API   light hsl client api
  * @brief Functions declaration
  * @{
  */
...
mesh_msg_send_cause_t light_hsl_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                    uint8_t app_key_index, uint16_t lightness, uint16_t hue, int16_t saturation, uint8_t tid,
...
mesh_msg_send_cause_t light_hsl_hue_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                        uint8_t app_key_index, uint16_t hue, uint8_t tid, bool optional,
...
mesh_msg_send_cause_t light_hsl_saturation_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                               uint8_t app_key_index, int16_t saturation, uint8_t tid, bool optional,
                                               generic_transition_time_t trans_time, uint8_t delay, bool ack);
...
mesh_msg_send_cause_t light_hsl_default_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                            uint8_t app_key_index, uint16_t lightness, uint16_t hue, int16_t saturation, bool ack);
...
mesh_msg_send_cause_t light_hsl_range_set(const mesh_model_info_p pmodel_info, uint16_t dst,
                                          uint8_t app_key_index, uint16_t hue_range_min, uint16_t hue_range_max,
