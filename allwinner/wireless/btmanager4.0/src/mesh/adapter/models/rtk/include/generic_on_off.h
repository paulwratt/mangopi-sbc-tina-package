...
#define RTK_MESH_MODEL_GENERIC_ON_OFF_SERVER                0x1000
#define RTK_MESH_MODEL_GENERIC_ON_OFF_CLIENT                0x1001
/** @} */

/** @defgroup GENERIC_ON_OFF_MSG generic on off msg
  * @brief Message types used by generic on off models
  * @{
  */
typedef enum
{
...
/** @defgroup GENERIC_ON_OFF_TRANSITION_TYPE generic on off transition type
  * @brief
  * @{
  */
...
/** @defgroup GENERIC_ON_OFF_SERVER_DATA generic on off server data
...
/** @defgroup GENERIC_ON_OFF_CLIENT_DATA generic on off client data
  * @brief Data types and structure used by data process callback
  * @{
  */
