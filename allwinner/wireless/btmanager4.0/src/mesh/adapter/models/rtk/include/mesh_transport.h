...
/** @addtogroup Mesh_Transport Mesh Transport
  * @brief
  * @{
  */

/** @defgroup Mesh_Transport_Exported_Macros Mesh Transport Exported Macros
  * @brief
  * @{
  */
...
/** @defgroup Mesh_Transport_Exported_Types Mesh Transport Exported Types
  * @brief
  * @{
  */
typedef enum
...
typedef struct
{
    ...
    uint8_t seg: 1; //!< @ref TMeshTransTCF
...
/** @defgroup Mesh_Transport_Exported_Functions Mesh Transport Exported Functions
  * @brief
  * @{
  */
...
mesh_msg_send_cause_t trans_hb(uint16_t dst, uint8_t net_key_index, uint8_t init_ttl,
...
/**
  ...
  * @return send result
  */
mesh_msg_send_cause_t trans_ping(uint16_t dst, uint8_t ttl, uint8_t net_key_index,
...
/**
  ...
  * @return send result
  */
mesh_msg_send_cause_t trans_pong(uint16_t dst, uint8_t ttl, uint8_t net_key_index,
