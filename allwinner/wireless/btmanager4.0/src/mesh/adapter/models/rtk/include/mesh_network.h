...
/** @addtogroup Mesh_Network Mesh Network
  * @brief
  * @{
  */

/** @defgroup Mesh_Network_Exported_Macros Mesh Network Exported Macros
  * @brief
  * @{
  */
...
/** @defgroup Mesh_Network_Exported_Types Mesh Network Exported Types
  * @brief
  * @{
  */
...
/** @defgroup Mesh_Network_Exported_Functions Mesh Network Exported Functions
  * @brief
  * @{
  */
