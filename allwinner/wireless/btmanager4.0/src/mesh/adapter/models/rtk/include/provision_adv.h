...
/** @addtogroup PB_Adv PB Adv
  * @brief
  * @{
  */

/** @defgroup PB_Adv_Exported_Macros PB Adv Exported Macros
...
/** @defgroup Pb_Adv_Exported_Types Pb Adv Exported Types
...
/** @defgroup Pb_Adv_Exported_Functions Pb Adv Exported Functions
...
/**
  ...
  * @param[in] device_uuid: remote device uuid
  * @return send result
  */
bool pb_adv_link_open(uint8_t ctx_index, uint8_t device_uuid[16]);
