...
#define MIN_TRANSMIT_INTERVAL	20
#define MIN_TRANSMIT_CNT	1

#define MESH_BLE_ADDR_LEN        (6)

#ifdef CONFIG_XR829_BT
//friendship status
#define FRIENDSHIP_CONNECTED	1
#define FRIENDSHIP_DISCONNECTED	0

#define FRIEND_NO_ERROR         0
#define FRIEND_FEATURE_DISABLE  1
#define FRIEND_POLLTIMEOUT      2
#define FRIEND_CLEAR            3
#define FRIEND_NET_FREE         4
#endif
