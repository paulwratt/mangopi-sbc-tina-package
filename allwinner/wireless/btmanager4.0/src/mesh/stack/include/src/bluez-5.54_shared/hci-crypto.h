...
bool bt_hci_crypto_prand(struct bluez554_bt_hci *hci,
			bt_hci_crypto_func_t callback, void *user_data);
bool bt_hci_crypto_e(struct bluez554_bt_hci *hci,
			const uint8_t key[16], const uint8_t plaintext[16],
			bt_hci_crypto_func_t callback, void *user_data);
bool bt_hci_crypto_d1(struct bluez554_bt_hci *hci,
			const uint8_t k[16], uint16_t d, uint16_t r,
			bt_hci_crypto_func_t callback, void *user_data);
bool bt_hci_crypto_dm(struct bluez554_bt_hci *hci,
			const uint8_t k[16], const uint8_t r[8],
			bt_hci_crypto_func_t callback, void *user_data);
bool bt_hci_crypto_ah(struct bluez554_bt_hci *hci,
