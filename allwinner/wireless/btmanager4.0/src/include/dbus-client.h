...
#define BA_PCM_TRANSPORT_MASK_HFP (BA_PCM_TRANSPORT_HFP_HF | BA_PCM_TRANSPORT_HFP_AG)
#define BA_PCM_TRANSPORT_MASK_HSP (BA_PCM_TRANSPORT_HSP_HS | BA_PCM_TRANSPORT_HSP_AG)
#define BA_PCM_TRANSPORT_MASK_SCO (BA_PCM_TRANSPORT_MASK_HFP | BA_PCM_TRANSPORT_MASK_HSP)
#define BA_PCM_TRANSPORT_MASK_AG (BA_PCM_TRANSPORT_HSP_AG | BA_PCM_TRANSPORT_HFP_AG)
#define BA_PCM_TRANSPORT_MASK_HF (BA_PCM_TRANSPORT_HSP_HS | BA_PCM_TRANSPORT_HFP_HF)
...
#define BA_PCM_VOLUME_MAX(pcm) ((pcm)->transport & BA_PCM_TRANSPORT_MASK_A2DP ? 127 : 15)
