...
static unsigned int getLbcModBuferrSize(LayerContext* lc, unsigned int nGpuBufWidth, unsigned int nGpuBufHeight)
{
    ...
    */
    ...
    for(i=0; i<lc->nGpuBufferCount; i++)
    {
        ...
        else
        {
            ...
            {
		bufferSize = getLbcModBuferrSize(lc, nGpuBufWidth, nGpuBufHeight);
